...
<head><title></title>
    ...
    <?
        //$APPCLICATION->AddHeadScript(SITE_TEMPLATE_PATH.'');
    ?>

    <link rel="shortcut icon" href="<? echo SITE_TEMPLATE_PATH ?>/images/favicon.604825ed.ico" type="image/x-icon">
    <link href="<? echo SITE_TEMPLATE_PATH ?>/css/common.css" rel="stylesheet">
...
<div id="barba-wrapper">
    <div class="article-list"><a class="article-item article-list__item" href="/for-individuals.html"
                                 data-anim="anim-3">
            <div class="article-item__background"><img src="<? echo SITE_TEMPLATE_PATH ?>/images/article-item-bg-6.jpg"
            ...
            <div class="article-item__wrapper">
                ...
                <div class="article-item__content">Лучшие решения для вашего дома: быстрый интернет, доступное кабельное&nbsp;TV,
                    удобный домашний телефон body in index
                </div>
            </div>
        </a><a class="article-item article-list__item" href="#" data-anim="anim-3">
            <div class="article-item__background"><img src="<? echo SITE_TEMPLATE_PATH ?>/images/article-item-bg-3.jpg"
            ...
            <div class="article-item__background"><img src="<? echo SITE_TEMPLATE_PATH ?>/images/article-item-bg-4.jpg"
            ...
            <div class="article-item__background"><img src="<? echo SITE_TEMPLATE_PATH ?>/images/article-item-bg-5.jpg"
            ...
            <div class="article-item__background"><img src="<? echo SITE_TEMPLATE_PATH ?>/images/article-item-bg-2.jpg"
            ...
            <div class="article-item__background"><img src="<? echo SITE_TEMPLATE_PATH ?>/images/article-item-bg-1.jpg"
