...
<head><title></title>
    ...
    <link rel="shortcut icon" href="<? echo $templateFolder ?>/images/favicon.604825ed.ico" type="image/x-icon">
    <link href="<? echo $templateFolder ?>/css/common.css" rel="stylesheet">

    templateFolder <br>
    <? echo $templateFolder ?> <br>
    <? //echo $custom_template_styles_path ?>
    <? //define("$custom_template_styles_path", "<? echo $templateFolder ?>") ?>
    SITE_TEMPLATE_PATH <br>
    <? echo SITE_TEMPLATE_PATH?>
</head>

<body>
<div id="barba-wrapper">
    <div class="article-list"><a class="article-item article-list__item" href="<? echo $templateFolder ?>/for-individuals.html"
                                 data-anim="anim-3">
